...
exports.generateContent = async (req, res, next) => {
  try {
    ...
    Second is hero section with json key "hero" so generate a headline with json key "headline", short description with json key "shortDescription", a prompt to generate an image with an aspect ratio of 1:1 above headline and short description with json key "visualFile", and a prompt to generate image without confirmation for the background with json key "backgroundContent" for hero section.
